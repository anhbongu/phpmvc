    ...
    <div id="content-box">
        ...
        <?php 
            ...
            //select group
            $checked        = isset($this->arrParam['filter_group_id']) ? $this->arrParam['filter_group_id'] : 'default';
    
            $arrGroup      = $this->ỉtemselectbox;
            $groupSlectbox = Helper::cmsSelectBox('filter_group_id', $arrGroup, $checked);
                ...
                <form action="#" method="post" name="adminForm" id="adminForm">
                    ...
                    <fieldset id="filter-bar">
                        ...
                        <div class="filter-select fltrt">
                            ...
                            <?php echo $statusSlectbox.$groupSlectbox; ?>
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><a href="#">Group_id</a></th>
                            ...
                            <?php 
                                if(!empty($this->list)){
                                    ...
                                    foreach ($this->list as $key => $value) {
                                        ...
                                        $status = Helper::cmsStatus($value['status'],URL::creatLink('admin', 'user','ajaxStatus', array('id'=>$id, 'status'=>$value['status']), 'js'),$id);
                                        ...
                                        $linkEdit = URL::creatLink('admin', 'user', 'edit', array('id'=>$id));
                                            ?>
                                                <tr class="<?php echo $classRow;  ?>">
                                                    ...
                                                    <td><a href=""></a><?php echo $email; ?></td>
                                                    <td><a href=""></a><?php echo $fullname; ?></td>
                                                 
                                                    <td class="center"><?php echo $status; ?></td>
                                                    <td class="center"><?php echo $group_name; ?></td>
                    ...
                    <div>
                        <input type="hidden" name="filter_column" value="username"> <!-- sắp xêp theo cột nào mặc định là xs theo name -->
