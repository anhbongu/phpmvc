 <?php 
 	...
 	$inputUserName 		= Helper::cmsInput('text', 'form[username]', 'username', $valueUserName, 'inputbox', 40);
				...
				<div class="width-100 fltlft">
					<fieldset class="adminform">
						...
						<ul class="adminformlist">
							<?php echo $rowUserName.$rowEmail.$rowFullName.$rowOrdering.$rowStatus.$rowGroup?>
