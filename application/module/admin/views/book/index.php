    ...
    <div id="content-box">
        ...
        <?php 
            ...
            //select category
            $checked        = isset($this->arrParam['filter_category_id']) ? $this->arrParam['filter_category_id'] : 'default';
    
            $arrCategory      = $this->ỉtemselectbox;
            $categorySlectbox = Helper::cmsSelectBox('filter_category_id', $arrCategory, $checked);
                ...
                <form action="#" method="post" name="adminForm" id="adminForm">
                    ...
                    <fieldset id="filter-bar">
                        ...
                        <div class="filter-select fltrt">
                            ...
                            <?php echo $statusSlectbox.$categorySlectbox?>
                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="10%"><a href="#">Category_name</a></th>
                                <th width="10%"><a href="#">Description</a></th>
                                <th width="10%"><a href="#">price</a></th>
                                <th width="10%"><a href="#">Sale off</a></th>
                                <th width="10%"><a href="#">Special</a></th>
                            ...
                            <?php 
                                if(!empty($this->list)){
                                    ...
                                    foreach ($this->list as $key => $value) {
                                        ...
                                        //index.php?controller=group&action=ajaxStatus&id=1&status=0
                                        $status = Helper::cmsStatus($value['status'],URL::creatLink('admin', 'book','ajaxStatus', array('id'=>$id, 'status'=>$value['status']), 'js'),$id);
                                        ...
                                        $linkEdit = URL::creatLink('admin', 'book', 'edit', array('id'=>$id));
                                            ?>
                                                <tr class="<?php echo $classRow;  ?>">
                                                    ...
                                                    <td><a href=""></a><?php echo $category_name; ?></td>
                                                    <td><a href=""></a><?php echo $description; ?></td>
                                                    <td><a href=""></a><?php echo $price; ?></td>
                                                    <td><a href=""></a><?php echo $sale_off; ?></td>
                                                    <td><a href=""></a><?php echo $special; ?></td>
                                                    <td><a href=""></a><?php echo $picture; ?></td>
