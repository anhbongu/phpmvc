                    ...
                    <table class="adminlist" id="modules-mgr">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="10%">Group ACP<a href="#"></a></th>
                            ...
                            <?php 
                                if(!empty($this->list)){
                                    ...
                                    foreach ($this->list as $key => $value) {
                                        ...
                                        $status = Helper::cmsStatus($value['status'],URL::creatLink('admin', 'group','ajaxStatus', array('id'=>$id, 'status'=>$value['status']), 'js'),$id);
                                        
                                        $group_acp = Helper::cmsGroupACP($value['group_acp'],URL::creatLink('admin', 'group','ajaxACP', array('id'=>$id, 'group_acp'=>$value['group_acp']), 'js'),$id);
                                        ...
                                        $linkEdit = URL::creatLink('admin', 'group', 'edit', array('id'=>$id));
                                            ?>
